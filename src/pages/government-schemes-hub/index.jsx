...
const GovernmentSchemesHub = () => {
  ...
  const schemes = [
    ...
    },
    {
      ...
      applicationStatus: null,
      isSaved: true,
      applicationUrl: "https://pmaymis.gov.in/PMAYMIS2_2024/PmayDefault.aspx"
    }
  ];
  ...
  const successStories = [
    {
      ...
      photo: "/assets/images/lakshmi.jpg",
    ...
    },
    {
      ...
      photo: "/assets/images/engineer.jpg",
    ...
    },
    {
      id: 3,
      name: "Meera Bai",
      nameTelugu: "మీరా బాయి",
      location: "Utnoor, Adilabad",
      photo: "/assets/images/meera.jpg",
      scheme: "Tribal Women Empowerment",
      summary: "Meera established a handicraft cooperative employing 40 tribal women artisans, exporting traditional crafts globally and preserving cultural heritage.",
      summaryTelugu: "మీరా 40 మంది గిరిజన మహిళా కళాకారులకు ఉపాధి కల్పిస్తూ హస్తకళ సహకార సంఘాన్ని స్థాపించింది, సాంప్రదాయ శిల్పాలను ప్రపంచవ్యాప్తంగా ఎగుమతి చేస్తూ సాంస్కృతిక వారసత్వాన్ని పరిరక్షిస్తోంది.",
      impact: {
        income: "₹95,000",
        beneficiaries: "40"
      },
      achievements: [
        "International craft exhibition participant",
        "Women empowerment award recipient",
        "Preserved 15+ traditional art forms"
      ],
      quote: "Our traditional art became our source of economic freedom.",
      quoteTelugu: "మా సాంప్రదాయ కళ మా ఆర్థిక స్వేచ్ఛకు మూలం అయింది."
    },
    {
      id: 4,
      name: "Suresh Naik",
      nameTelugu: "సురేష్ నాయక్",
      location: "Bhadrachalam, Khammam",
      photo: "/assets/images/suresh.png",
      scheme: "Digital India Tribal Scheme",
      summary: "After digital literacy training, Suresh opened a technology center in his village, providing computer education to 200+ students and digital services to the community.",
      summaryTelugu: "డిజిటల్ అక్షరాస్యత శిక్షణ తర్వాత, సురేష్ తన గ్రామంలో సాంకేతిక కేంద్రాన్ని ప్రారంభించి, 200+ మంది విద్యార్థులకు కంప్యూటర్ విద్యను మరియు సమాజానికి డిజిటల్ సేవలను అందిస్తున్నాడు.",
      impact: {
        income: "₹65,000",
        beneficiaries: "200"
      },
      achievements: [
        "First digital center in remote area",
        "Trained 200+ students",
        "E-governance facilitator"
      ],
      quote: "Technology bridged the gap between my village and the world.",
      quoteTelugu: "సాంకేతికత నా గ్రామం మరియు ప్రపంచం మధ్య అంతరాన్ని తగ్గించింది."
    },
    {
      id: 5,
      name: "Anjali Devi",
      nameTelugu: "అంజలి దేవి",
      location: "Lambasingi, Visakhapatnam",
      photo: "/assets/images/anjali.png",
      scheme: "Tribal Healthcare Initiative",
      summary: "Anjali became a certified healthcare worker through Ayushman Bharat, now serves as a community health officer treating 500+ tribal families monthly.",
      summaryTelugu: "అంజలి ఆయుష్మాన్ భారత్ ద్వారా సర్టిఫైడ్ ఆరోగ్య కార్యకర్తగా మారింది, ఇప్పుడు నెలవారీ 500+ గిరిజన కుటుంబాలకు చికిత్స చేస్తూ సమాజ ఆరోగ్య అధికారిగా పని చేస్తోంది.",
      impact: {
        income: "₹55,000",
        beneficiaries: "500"
      },
      achievements: [
        ...
        "Mobile health clinic operator",
        "Saved 100+ lives through early detection"
      ],
      quote: "Healthcare is not just a job, it's my way of serving my community.",
      quoteTelugu: "ఆరోగ్య సంరక్షణ కేవలం ఉద్యోగం కాదు, ఇది నా సమాజానికి సేవ చేసే మార్గం."
    },
    {
      id: 6,
      name: "Prakash Rao",
      nameTelugu: "ప్రకాష్ రావు",
      location: "Eturnagaram, Warangal",
      photo: "/assets/images/prakash.png",
      scheme: "Tribal Housing Scheme",
      summary: "Prakash became a certified mason through housing scheme training, has built 80+ eco-friendly homes for tribal families and trained 30 youth in sustainable construction.",
      summaryTelugu: "ప్రకాష్ గృహ పథక శిక్షణ ద్వారా సర్టిఫైడ్ రాజు కాబట్టి అయ్యాడు, 80+ గిరిజన కుటుంబాలకు పర్యావరణ అనుకూల గృహాలను నిర్మించి 30 మంది యువతకు స్థిరమైన నిర్మాణంలో శిక్షణ ఇచ్చాడు.",
      impact: {
        income: "₹75,000",
        beneficiaries: "80"
      },
      achievements: [
        "Certified green building expert",
        "Built 80+ sustainable homes",
        "Started construction training institute"
      ],
      quote: "Building homes is building futures for our community.",
      quoteTelugu: "గృహాలను నిర్మించడం అంటే మా సమాజం కోసం భవిష్యత్తులను నిర్మించడం."
    }
  ];
  ...
  const handleApplyScheme = (scheme) => {
    // Open the scheme's specific application URL
    const url = scheme?.applicationUrl || 'https://india.gov.in';
